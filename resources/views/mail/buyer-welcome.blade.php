                ...
                <tr>
                    <td style="padding:38px 36px 8px;">
                        ...
                        <p style="margin:0; font-family:'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size:15px; line-height:1.6; color:#5B6068;">
                            Your account is ready. It's where your reservations, your deal status, and — once the keys are yours — your garage all live.
                        </p>
                    </td>
                </tr>
                            ...
                            <tr>
                                <td style="padding:18px 22px;">
                                    ...
                                    <p style="margin:0; font-family:'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size:14px; line-height:1.55; color:#1B6B53;">
                                        Creating an account is free. Reserving a car is always a separate, deliberate step you choose to take.
                                    </p>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                ...
                                <td style="padding-bottom:12px; font-family:'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size:14px; line-height:1.55; color:#3A3F46;">
                                    Browse certified cars — every listing is certified pre-owned with all-in pricing, so the number you see is the number you pay (before HST &amp; licensing).
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="padding-bottom:12px; font-family:'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size:14px; line-height:1.55; color:#3A3F46;">
                                    Reserve in minutes — a $150 fully-refundable deposit holds your exact car, and it credits straight to the purchase. It isn't an extra charge.
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="font-family:'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size:14px; line-height:1.55; color:#3A3F46;">
                                    Track everything in My Garage — your deal status, documents and financing stay in one place, start to finish.
                                </td>
                            </tr>
                        </table>
                    </td>
                        ...
                        <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td align="center" bgcolor="#F5631F" style="border-radius:10px;">
                                    <a href="{{ url('/') }}" target="_blank" style="display:inline-block; padding:14px 30px; font-family:'Geist', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size:15px; font-weight:700; color:#FFFFFF; text-decoration:none; border-radius:10px;">
